...
from automatic_prompt_engineer.automatic_prompt_engineer import llm
...
def get_eval_method(eval_method):
    ...
    if eval_method == 'likelihood':
        from automatic_prompt_engineer.automatic_prompt_engineer.evaluation import likelihood
        return likelihood.likelihood_evaluator
    elif eval_method == 'bandits':
        from automatic_prompt_engineer.automatic_prompt_engineer.evaluation import bandits
